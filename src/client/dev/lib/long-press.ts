...
;(function (window, document) {
  ...
  function startLongPressTimer(e) {
      ...
      // get delay from html attribute if it exists, otherwise use default
      var longPressDelayInMs = parseInt(getNearestAttribute(el, 'data-long-press-delay', String(DEFAULT_PRESS_TIME)), 10);
